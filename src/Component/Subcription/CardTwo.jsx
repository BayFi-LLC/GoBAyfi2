...
const CardTwo = () => {
  return (
    <div className="card card-2 glass2 relative z-30 mx-auto mt-10 w-full max-w-[400px] overflow-hidden rounded-xl px-6 py-10 backdrop-blur-lg">
      {/* Icon Container */}
      ...
      <p className="mt-2 text-center text-sm text-white opacity-90">
        Get your solutions quickly, ensuring timely delivery.
      </p>
