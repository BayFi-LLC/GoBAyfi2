...
const PricingNavbarDekstop = () => {
  ...
  return (
    <section className="hidden lg:block">
      <nav className="z-50 mx-auto box-border flex h-14 w-full items-center justify-between rounded-full  bg-[rgba(255,255,255,0.05)] backdrop-blur-[28.4754467px]
...
export default PricingNavbarDekstop;
